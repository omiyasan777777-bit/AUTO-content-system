...
function RequiredBadge() {
  return (
    <span className="ml-2 rounded-full bg-mauve-600 px-2 py-0.5 text-[10px] font-bold text-white">
      必須
    </span>
  );
}
...
function OptionalBadge() {
  return (
    <span className="ml-2 rounded-full bg-lavender px-2 py-0.5 text-[10px] font-bold text-ink-soft">
      任意
    </span>
  );
}
...
const inputClass =
  "mt-2 w-full min-h-12 rounded-xl border border-mauve-200 bg-white px-4 py-3 text-base text-ink placeholder:text-ink-faint focus:border-mauve-500";
const labelClass = "flex items-center text-sm font-bold text-ink";
  ...
  return (
    <div className="mx-auto w-full max-w-md px-6 pb-16 pt-8">
      ...
      <div className="mt-4 text-center">
        <p className="text-xs tracking-[0.3em] text-gold">STEP 2 / 2</p>
      ...
      >
        ...
        {/* ---- 任意項目 ---- */}
        <div className="rounded-2xl border border-mauve-200/60 bg-white/60 p-5">

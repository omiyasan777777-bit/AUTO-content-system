    ...
    >
      <div aria-hidden="true" className="relative h-32 w-32">
        <span className="absolute inset-0 flex items-center justify-center">
          <Moon className="h-14 w-14 animate-float text-mauve-500" />
        </span>
      ...
      <p className="mt-8 font-serif text-lg text-ink">{MESSAGES[index]}</p>
      <p className="mt-3 text-xs text-ink-faint">そのままお待ちください</p>
    </div>
  );
}

...
- 💣 **ボンバー**: Claude Code のオレンジキャラが主人公のボンバーマン風ゲーム。矢印/WASDで移動、Spaceで爆弾。ブロックを壊して🔥火力UP・💣爆弾数UPを取り、敵ゴーストを全滅させるとステージクリア（タブで切替）
...
- `public/bomber.js` … canvas 製ボンバーマン風ゲーム（グリッド移動・爆風連鎖・敵AI）
